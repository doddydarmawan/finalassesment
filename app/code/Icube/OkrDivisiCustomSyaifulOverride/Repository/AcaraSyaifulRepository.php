<?php
namespace Icube\OkrDivisiCustomSyaifulOverride\Repository;
...
use Icube\OkrDivisiCustomSyaiful\Repository\AcaraSyaifulRepository as AcaraRepo;

class AcaraSyaifulRepository extends AcaraRepo
{
    ...
    private function setField($acaraSyaiful, $input){
        ...
        $acaraSyaiful->setTanggal($input["tanggal"]);
        return $acaraSyaiful;
    }
}